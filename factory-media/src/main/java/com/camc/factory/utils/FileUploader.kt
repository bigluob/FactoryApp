...
object FileUploader {
    ...
    private val tokenDefault =
        "eyJhbGciOiJub25lIiwidHlwIjoiQmVhcmVyIn0.eyJwcmltYXJ5c2lkIjoiMTU3NzU5NDcxNDE2ODgxOTcxMiIsImh0dHA6Ly9zY2hlb" +
        ...
        scope.launch {
            try {
                ...
                for (file in files) {
                    ...
                    val response = apiService.uploadFile(token, body)
